<tbody>
	<tr>
		<td style="padding:40px 0  0 0;">
			...
			<p style="font-size: 13px;line-height:24px;font-family:'HelveticaNeue','Helvetica Neue',Helvetica,Arial,sans-serif;">You've successfully created a kDNS account. To activate it, please click below to verify your email address.
				<br>
				<br>
